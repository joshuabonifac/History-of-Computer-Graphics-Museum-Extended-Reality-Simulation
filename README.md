...
This Simulation covers the history on Computer Graphics, including Sketchpad, Silicon Graphics, OpenGL, and GPUs. This has also been done for the Technology Student Association Virtual Reality Simulation Competition within the Pre-Conference Submission.
...
This can also help me prepare for the research side of the field when reading SIGGRAPH papers, understanding algorithms, and optimization.
